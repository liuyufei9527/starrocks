...
public class DictQueryFunctionTest {
    ...
    public void testFunctionWithException() throws Exception {
        ...
        testDictMappingFunction(
                ...
                "dict_mapping function param size should be 3 or 4.");
        ...
        testDictMappingFunction(
                "SELECT dict_mapping('dict.dict_table', 'key', CAST('2023-05-06' AS datetime), 'key_dt');",
                "dict_mapping function value field 'key_dt' should be bigint.");
    }
